...
namespace TotalDAL.Repositories
{
    public class BaseRepository : IBaseRepository
    {
        ...
        public void CreateStoredProcedure()
        {
            ...
            semifinishedItem.RestoreProcedure();
            ...
            Helpers.SqlProgrammability.Productions.FinishedItem finishedItem = new Helpers.SqlProgrammability.Productions.FinishedItem(totalSmartPortalEntities);
            finishedItem.RestoreProcedure();
