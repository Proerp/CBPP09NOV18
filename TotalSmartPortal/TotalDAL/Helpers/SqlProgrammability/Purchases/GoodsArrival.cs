...
namespace TotalDAL.Helpers.SqlProgrammability.Purchases
{
    public class GoodsArrival
    {
        ...
        private void GoodsArrivalToggleApproved()
        {
            ...
            queryString = queryString + "                                       INSERT INTO GoodsArrivalPackages(EntryDate, GoodsArrivalID, GoodsArrivalDetailID, LocationID, CustomerID, TransporterID, PurchaseOrderID, PurchaseOrderDetailID, CommodityID, CommodityTypeID, WarehouseID, SerialID, LabID, Code, SealCode, BatchCode, LabCode, Barcode, ProductionDate, ExpiryDate, BatchID, BatchEntryDate, Quantity, QuantityReceipted, UnitWeight, TareWeight, Packages, Remarks, VoidTypeID, Approved, InActive, InActivePartial, InActivePartialDate) " + "\r\n";
