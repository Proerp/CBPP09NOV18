...
namespace TotalDAL.Helpers.SqlProgrammability.Purchases
{
    public class GoodsArrival
    {
        ...
        private string GetGoodsArrivalIndexSQL(bool pendingOnly)
        {
            ...
            queryString = queryString + "       SELECT      GoodsArrivals.GoodsArrivalID, CAST(GoodsArrivals.EntryDate AS DATE) AS EntryDate, GoodsArrivals.Reference, GoodsArrivals.Code, GoodsArrivals.PackingList, GoodsArrivals.CustomsDeclaration, GoodsArrivals.PurchaseOrderID, GoodsArrivals.PurchaseOrderCodes, GoodsArrivals.PurchaseOrderReferences, PurchaseOrders.EntryDate AS PurchaseOrderEntryDate, Locations.Code AS LocationCode, Customers.Name AS CustomerName, Transporters.Name AS TransporterName, GoodsArrivals.Description, GoodsArrivals.TotalQuantity, GoodsArrivals.TotalQuantityReceipted, GoodsArrivals.TotalPackages, GoodsArrivals.Approved " + "\r\n";
