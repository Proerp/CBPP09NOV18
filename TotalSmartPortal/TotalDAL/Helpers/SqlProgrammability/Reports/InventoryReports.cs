...
namespace TotalDAL.Helpers.SqlProgrammability.Reports
{
    public class InventoryReports
    {
        ...
        private void WarehouseCards()
        {
            ...
            queryString = queryString + "                   Commodities.CommodityID, Commodities.Code, Commodities.CodePartA, Commodities.CodePartB, Commodities.CodePartC, Commodities.CodePartD, Commodities.CodePartE, Commodities.CodePartF, Commodities.Name, Commodities.SalesUnit, Commodities.LeadTime, WarehouseJournalMaster.Reference, WarehouseJournalMaster.Referral, WarehouseJournalMaster.ReceiptCode, " + "\r\n";
            queryString = queryString + "                   ISNULL(Warehouses.LocationID, 0) AS LocationID, ISNULL(Warehouses.WarehouseCategoryID, 0) AS WarehouseCategoryID, ISNULL(Warehouses.WarehouseID, 0) AS WarehouseID, ISNULL(Warehouses.Name, '') AS WarehouseName, " + "\r\n";
            ...
            queryString = queryString + "                   UNION ALL " + "\r\n";
            //UNDO MaterialIssueDetails
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, MaterialIssueDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, PackageIssueDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   UNION ALL " + "\r\n";
            //UNDO WarehouseTransferDetails
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, WarehouseTransferDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   UNION ALL " + "\r\n";
            //UNDO WarehouseAdjustmentDetails
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, -WarehouseAdjustmentDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.IssuePRO + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, BlendingInstructions.Jobs AS Specs, Commodities.Code + ' - ' + Commodities.OfficialCode AS Specification, BlendingInstructions.Code AS BlendingInstructionCode, 'PackageIssues' AS ControllerName, PackageIssueDetails.PackageIssueID AS EntityID, N'HH TẠI KHO' AS GroupName, CONVERT(VARCHAR, @LocalFromDate, 103) + ' -> ' + CONVERT(VARCHAR, @LocalToDate, 103) AS SubGroupName, PackageIssueDetails.EntryDate, GoodsReceiptDetails.CommodityID, PackageIssueDetails.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'MÁY ' + ProductionLines.Code + ' ' + Workshifts.Code + ' [' + CONVERT(VARCHAR, PackageIssueDetails.EntryDate, 103) + ']' +  ', KH: ' + Customers.Name AS Description, 0 AS QuantityDebit, PackageIssueDetails.Quantity AS QuantityCredit " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ReceiptPENDING + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, FirmOrders.Specs, FirmOrders.Specification, FirmOrders.Code AS FirmOrderCode, 'Productions/FinishedProducts' AS ControllerName, FinishedProductPackages.FinishedProductID AS EntityID, N'TỒN SX [DỞ DANG]' AS GroupName, 'X.' + CONVERT(VARCHAR, @LocalToDate, 103) AS SubGroupName, FinishedProductPackages.EntryDate, FinishedProductPackages.CommodityID, NULL AS Reference, NULL AS Referral, NULL AS ReceiptCode, 0 AS WarehouseID, Customers.Name + ', KHSX: ' + FirmOrders.Reference + ' SCT [' + ISNULL(FirmOrders.Code, '') + ' Ngày: ' + CONVERT(VARCHAR, FirmOrders.EntryDate, 103) + ']' AS Description, FinishedProductPackages.Quantity - FinishedProductPackages.QuantityReceipted AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ReceiptPENDING + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, FirmOrders.Specs, FirmOrders.Specification, FirmOrders.Code AS FirmOrderCode, 'Productions/FinishedProducts' AS ControllerName, FinishedProducts.FinishedProductID AS EntityID, N'TỒN SX [DỞ DANG]' AS GroupName, 'X.' + CONVERT(VARCHAR, @LocalToDate, 103) AS SubGroupName, FinishedProducts.EntryDate, GoodsReceiptDetails.CommodityID, NULL AS Reference, NULL AS Referral, NULL AS ReceiptCode, 0 AS WarehouseID, Customers.Name + ', KHSX: ' + FirmOrders.Reference + ' SCT [' + ISNULL(FirmOrders.Code, '') + ' Ngày: ' + CONVERT(VARCHAR, FirmOrders.EntryDate, 103) + ']' AS Description, GoodsReceiptDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ReceiptPENDING + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, FirmOrders.Specs, FirmOrders.Specification, FirmOrders.Code AS FirmOrderCode, 'Inventories/' + IIF(MaterialIssueDetails.NmvnTaskID = " + (int)GlobalEnums.NmvnTaskID.MaterialStaging + ", 'MaterialStagings', IIF(MaterialIssueDetails.NmvnTaskID = " + (int)GlobalEnums.NmvnTaskID.ItemStaging + ", 'ItemStagings', 'ProductStagings')) AS ControllerName, MaterialIssueDetails.MaterialIssueID AS EntityID, N'TỒN SX [DỞ DANG]' AS GroupName, 'X.' + CONVERT(VARCHAR, @LocalToDate, 103) AS SubGroupName, MaterialIssueDetails.EntryDate, GoodsReceiptDetails.CommodityID, MaterialIssueDetails.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'MÁY ' + ProductionLines.Code + ' ' + Workshifts.Code + ' [' + CONVERT(VARCHAR, MaterialIssueDetails.EntryDate, 103) + ']' +  ', KH: ' + Customers.Name AS Description, ROUND(MaterialIssueDetails.Quantity - MaterialIssueDetails.QuantitySemifinished - MaterialIssueDetails.QuantityFailure - MaterialIssueDetails.QuantityReceipted - MaterialIssueDetails.QuantityLoss, " + (int)GlobalEnums.rndQuantity + ") AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        MaterialIssueDetails INNER JOIN " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ReceiptPENDING + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, FirmOrders.Specs, FirmOrders.Specification, FirmOrders.Code AS FirmOrderCode, 'Inventories/' + IIF(MaterialIssues.NmvnTaskID = " + (int)GlobalEnums.NmvnTaskID.MaterialStaging + ", 'MaterialStagings', IIF(MaterialIssues.NmvnTaskID = " + (int)GlobalEnums.NmvnTaskID.ItemStaging + ", 'ItemStagings', 'ProductStagings')) AS ControllerName, MaterialIssues.MaterialIssueID AS EntityID, N'TỒN SX [DỞ DANG]' AS GroupName, 'X.' + CONVERT(VARCHAR, @LocalToDate, 103) AS SubGroupName, MaterialIssues.EntryDate, GoodsReceiptDetails.CommodityID, MaterialIssues.Reference, GoodsReceiptDetails.Reference AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'MÁY ' + ProductionLines.Code + ' ' + Workshifts.Code + ' [' + CONVERT(VARCHAR, MaterialIssues.EntryDate, 103) + ']' +  ', KH: ' + Customers.Name AS Description, GoodsReceiptDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails INNER JOIN " + "\r\n";
