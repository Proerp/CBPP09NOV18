...
namespace TotalDAL.Helpers.SqlProgrammability.Reports
{
    public class InventoryReports
    {
        ...
        private void WarehouseCards()
        {
            ...
            queryString = queryString + "                   UNION ALL " + "\r\n";
            //UNDO MaterialIssueDetails
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, NULL AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, MaterialIssueDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, NULL AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, PackageIssueDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   UNION ALL " + "\r\n";
            //UNDO WarehouseTransferDetails
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, NULL AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, WarehouseTransferDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
            ...
            queryString = queryString + "                   UNION ALL " + "\r\n";
            //UNDO WarehouseAdjustmentDetails
            queryString = queryString + "                   SELECT      " + (int)GlobalEnums.WarehouseAdjustmentTypeID.ALL + " AS JournalTypeID, Customers.CustomerID, Customers.Code AS CustomerCode, Customers.Name AS CustomerName, NULL AS Specs, NULL AS Specification, NULL AS FirmOrderCode, '' AS ControllerName, 0 AS EntityID, N'HH TẠI KHO' AS GroupName, N'DAU KY ' + CONVERT(VARCHAR, DATEADD (day, -1,  @LocalFromDate), 103) AS SubGroupName, GoodsReceiptDetails.EntryDate, GoodsReceiptDetails.CommodityID, GoodsReceiptDetails.Reference, NULL AS Referral, GoodsReceiptDetails.Code AS ReceiptCode, GoodsReceiptDetails.WarehouseID, N'' AS Description, -WarehouseAdjustmentDetails.Quantity AS QuantityDebit, 0 AS QuantityCredit " + "\r\n";
            queryString = queryString + "                   FROM        GoodsReceiptDetails " + "\r\n";
        ...
        private void SearchBarcodes()
        {
            ...
            this.totalSmartPortalEntities.CreateStoredProcedure("SearchBarcodes", queryString);
        }
