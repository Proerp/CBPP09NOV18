...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class SemifinishedRecyclate
    {
        ...
        private string BUILDSQLNew()
        {
            ...
            queryString = queryString + "                   Commodities.CommodityID, Commodities.Code AS CommodityCode, Commodities.CommodityTypeID, Commodities.RecycleCommodityID, RecycleCommodities.Code AS RecycleCommodityCode, RecycleCommodities.Name AS RecycleCommodityName, RecycleCommodities.CommodityTypeID AS RecycleCommodityTypeID, SemifinishedProducts.RejectWeights, SemifinishedProducts.FailureWeights, ISNULL(ROUND(SemifinishedProducts.RejectWeights + SemifinishedProducts.FailureWeights - SemifinishedProducts.RecycleWeights, " + (int)GlobalEnums.rndQuantity + "), 0) AS QuantityRemains, 0.0 AS Quantity " + "\r\n"; //QuantityRemains NOT INCLUDED RecycleLoss, BUT: CHECK PENDING MUST MINUS RecycleLoss!!!!!!
        ...
        private string BUILDSQLEdit()
        {
            ...
            queryString = queryString + "                   Commodities.CommodityID, Commodities.Code AS CommodityCode, Commodities.CommodityTypeID, Commodities.RecycleCommodityID, RecycleCommodities.Code AS RecycleCommodityCode, RecycleCommodities.Name AS RecycleCommodityName, RecycleCommodities.CommodityTypeID AS RecycleCommodityTypeID, SemifinishedProducts.RejectWeights, SemifinishedProducts.FailureWeights, ISNULL(ROUND(SemifinishedProducts.RejectWeights + SemifinishedProducts.FailureWeights - SemifinishedProducts.RecycleWeights + SemifinishedRecyclateDetails.Quantity, " + (int)GlobalEnums.rndQuantity + "), 0) AS QuantityRemains, SemifinishedRecyclateDetails.Quantity " + "\r\n";
