...
namespace TotalDAL.Helpers.SqlProgrammability.Productions
{
    public class PlannedOrder
    {
        ...
        private void GetPlannedOrderIndexes()
        {
            ...
            queryString = queryString + "                                               FirmOrderID int NULL, FirmOrderDetailID int NULL, SerialID int NULL, HasProductionOrders int NULL, CommodityCode nvarchar(50) NULL, CommodityName nvarchar(200) NULL, Approved bit NOT NULL, InActive bit NOT NULL, InActivePartial bit NOT NULL, VoidTypeName nvarchar(50) NULL, QuantityRequested decimal(18, 2) NULL, QuantityOnhand decimal(18, 2) NULL, Quantity decimal(18, 2) NULL, MoldQuantity decimal(18, 2) NULL, MoldWeight decimal(18, 2) NULL, PiecePerPack int NULL, " + "\r\n";
            ...
            //--------------------------ItemQuantityEstimated: Estimated Item (Material) Quantity based on weight
            ...
            queryString = queryString + "                   ItemCode, ItemWeight, ItemEntryDate, IIF(SerialID = 0, (Quantity * MoldWeight * ItemWeight)/ MoldQuantity, NULL) AS ItemQuantityEstimated, IIF(SerialID = 0, ItemQuantity, NULL) AS ItemQuantity, IIF(SerialID = 0 AND ItemQuantitySemifinished <> 0, ItemQuantitySemifinished, NULL) AS ItemQuantitySemifinished, IIF(SerialID = 0, ItemQuantityFailure, NULL) AS ItemQuantityFailure, IIF(SerialID = 0, ItemQuantityReceipted, NULL) AS ItemQuantityReceipted, IIF(SerialID = 0, ItemQuantityLoss, NULL) AS ItemQuantityLoss, IIF(SerialID = 0, ItemQuantity - ItemQuantityReceipted, NULL) AS ItemQuantityNet," + "\r\n";
        ...
        private string GetPlannedOrderIndexSQL(int dateOptionID, int filterOptionID)
        {
            ...
            queryString = queryString + "                                         FirmOrderID, FirmOrderDetailID, SerialID, HasProductionOrders, CommodityCode, CommodityName, Approved, InActive, InActivePartial, VoidTypeName, QuantityRequested, QuantityOnhand, Quantity, MoldQuantity, MoldWeight, PiecePerPack, " + "\r\n";
