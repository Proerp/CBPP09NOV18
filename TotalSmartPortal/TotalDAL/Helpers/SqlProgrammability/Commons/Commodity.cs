...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Commodity
    {
        ...
        private void CommoditySaveRelative()
        {
            ...
            queryString = queryString + "                   INSERT INTO     BomDetails (BomID, MaterialID, LayerCode, LayerQuantity, BlockUnit, BlockQuantity, Quantity, MajorStaple, Remarks, InActive) " + "\r\n";
            queryString = queryString + "                   SELECT          BomID, MaterialID, 'A' AS LayerCode, 1 AS LayerQuantity, 1 AS BlockUnit, 1 AS BlockQuantity, 1 AS Quantity, 1 AS MajorStaple, Remarks, InActive " + "\r\n";
