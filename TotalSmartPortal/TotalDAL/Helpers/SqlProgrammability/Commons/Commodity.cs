...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Commodity
    {
        ...
        private void GetCommodityIndexes()
        {
            ...
            queryString = queryString + "       SELECT      Commodities.CommodityID, EntireCommodityCategories.Name1 AS CommodityCategoryName1, EntireCommodityCategories.Name2 AS CommodityCategoryName2, Commodities.Code, Commodities.OfficialCode, Commodities.CodePartA, Commodities.CodePartB, Commodities.CodePartC, Commodities.CodePartD, Commodities.CodePartE, Commodities.CodePartF, Commodities.Name, Commodities.OfficialName, Commodities.SalesUnit, LTRIM(RTRIM(Commodities.Specification + ' ' + ISNULL(Commodities.Description, ''))) AS Specification, LTRIM(RTRIM(ISNULL(Commodities.Remarks, '') + ' ' + ISNULL(Commodities.Caption, ''))) AS Remarks, Commodities.Discontinue, Commodities.InActive, " + "\r\n";
