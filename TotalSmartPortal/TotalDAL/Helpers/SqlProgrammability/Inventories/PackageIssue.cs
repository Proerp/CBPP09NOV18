...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    public class PackageIssue
    {
        ...
        private void GetPackageIssueIndexes()
        {
            ...
            queryString = queryString + "       SELECT      PackageIssues.PackageIssueID, CAST(PackageIssues.EntryDate AS DATE) AS EntryDate, PackageIssues.Reference, Locations.Code AS LocationCode, Workshifts.Name AS WorkshiftName, ISNULL(BlendingInstructions.Description, '') + ' ' + ISNULL(PackageIssues.Description, '') AS Description, PackageIssues.TotalQuantity, PackageIssues.Approved, " + "\r\n";
            queryString = queryString + "                   Workshifts.EntryDate AS WorkshiftEntryDate, BlendingInstructions.Reference AS BlendingInstructionsReference, BlendingInstructions.Code AS BlendingInstructionsCode, BlendingInstructions.EntryDate AS BlendingInstructionEntryDate " + "\r\n";
        ...
        private void GetPackageIssueViewDetails()
        {
            ...
            queryString = queryString + "                   ROUND(BlendingInstructionDetails.Quantity - BlendingInstructionDetails.QuantityIssued + Issued_BlendingInstructionDetails.QuantityIssued, " + (int)GlobalEnums.rndQuantity + ") AS BlendingInstructionRemains, ROUND(GoodsReceiptDetails.Quantity - GoodsReceiptDetails.QuantityIssued + Issued_GoodsReceiptDetails.QuantityIssued, " + (int)GlobalEnums.rndQuantity + ") AS QuantityAvailables, PackageIssueDetails.Quantity, PackageIssueDetails.Remarks " + "\r\n";
        ...
        private string BuildSQLPendingDetails(bool isGoodsReceiptDetailIDs)
        {
            ...
            queryString = queryString + "       IF (@PackageIssueID <= 0) " + "\r\n";
            queryString = queryString + "               BEGIN " + "\r\n";
            ...
            queryString = queryString + "               BEGIN " + "\r\n";
            queryString = queryString + "                   " + this.BuildSQLNew(isGoodsReceiptDetailIDs) + " WHERE BlendingInstructionDetails.BlendingInstructionDetailID NOT IN (SELECT BlendingInstructionDetailID FROM PackageIssueDetails WHERE PackageIssueID = @PackageIssueID) " + "\r\n";
        ...
        private string BuildSQLNew(bool isGoodsReceiptDetailIDs)
        {
            ...
            queryString = queryString + "                   ROUND(BlendingInstructionDetails.Quantity - BlendingInstructionDetails.QuantityIssued, " + (int)GlobalEnums.rndQuantity + ") AS BlendingInstructionRemains, ROUND(GoodsReceiptDetails.Quantity - GoodsReceiptDetails.QuantityIssued, " + (int)GlobalEnums.rndQuantity + ") AS QuantityAvailables, 0 AS Quantity, CAST(0 AS bit) AS IsSelected " + "\r\n";
        ...
        private string BuildSQLEdit(bool isGoodsReceiptDetailIDs)
        {
            ...
            queryString = queryString + "       SELECT      BlendingInstructionDetails.BlendingInstructionDetailID, Commodities.CommodityID, Commodities.Code AS CommodityCode, Commodities.Name AS CommodityName, Commodities.OfficialCode, Commodities.CommodityTypeID, " + "\r\n";
            queryString = queryString + "                   GoodsReceiptDetails.GoodsReceiptID, GoodsReceiptDetails.GoodsReceiptDetailID, GoodsReceipts.Reference AS GoodsReceiptReference, GoodsReceipts.Code AS GoodsReceiptCode, GoodsReceipts.EntryDate AS GoodsReceiptEntryDate, GoodsReceiptDetails.BatchID, GoodsReceiptDetails.BatchEntryDate, " + "\r\n";
            queryString = queryString + "                   ROUND(BlendingInstructionDetails.Quantity - BlendingInstructionDetails.QuantityIssued + PackageIssueDetails.Quantity, " + (int)GlobalEnums.rndQuantity + ") AS BlendingInstructionRemains, ROUND(GoodsReceiptDetails.Quantity - GoodsReceiptDetails.QuantityIssued + ISNULL(IssuedGoodsReceiptDetails.Quantity, 0), " + (int)GlobalEnums.rndQuantity + ") AS QuantityAvailables, 0 AS Quantity, CAST(0 AS bit) AS IsSelected " + "\r\n";
