...
namespace TotalDAL.Helpers.SqlProgrammability.Inventories
{
    public class InventoryControl
    {
        ...
        private void GetInventoryControls()
        {
            ...
            queryString = " @AspUserID nvarchar(128), @SummaryOnly bit, @LabOptionID int, @FilterOptionID int, @PendingOptionID int, @ShelfLife int " + "\r\n";
            queryString = queryString + " WITH ENCRYPTION " + "\r\n";
            queryString = queryString + " AS " + "\r\n";
            queryString = queryString + "    BEGIN " + "\r\n";

            queryString = queryString + "       DECLARE     @LocalAspUserID nvarchar(128),      @LocalSummaryOnly bit,                      @LocalLabOptionID int,                      @LocalFilterOptionID int,                           @LocalPendingOptionID int,                              @LocalShelfLife int" + "\r\n";
            queryString = queryString + "       SET         @LocalAspUserID = @AspUserID        SET @LocalSummaryOnly = @SummaryOnly        SET @LocalLabOptionID = @LabOptionID        SET @LocalFilterOptionID = @FilterOptionID          SET @LocalPendingOptionID = @PendingOptionID            SET @LocalShelfLife = @ShelfLife " + "\r\n";
        ...
        private string GetInventoryControlFinalSQL(bool summaryOnly, int pendingOptionID)
        {
            ...
            queryString = queryString + "                   InventoryControls.EntryDate, InventoryControls.Code, InventoryControls.SealCode, InventoryControls.BatchCode, InventoryControls.LabCode, InventoryControls.Barcode, InventoryControls.ProductionDate, InventoryControls.ExpiryDate, InventoryControls.Approved, InventoryControls.LabApproved, " + "\r\n";
