    ...
    public static class NinjectWebCommon
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                kernel.Bind<IPurchaseMaterialService>().To<PurchaseMaterialService>();
                kernel.Bind<IPurchaseMaterialViewModelSelectListBuilder>().To<PurchaseMaterialViewModelSelectListBuilder>();
                kernel.Bind<IPurchaseItemService>().To<PurchaseItemService>();
                kernel.Bind<IPurchaseItemViewModelSelectListBuilder>().To<PurchaseItemViewModelSelectListBuilder>();
                kernel.Bind<IPurchaseProductService>().To<PurchaseProductService>();
                ...
                kernel.Bind<IPackageIssueService>().To<PackageIssueService>();
                kernel.Bind<IPackageIssueRepository>().To<PackageIssueRepository>();
                kernel.Bind<IPackageIssueAPIRepository>().To<PackageIssueAPIRepository>();
                ...
                kernel.Bind<IItemOrderService>().To<ItemOrderService>();
                kernel.Bind<IItemOrderViewModelSelectListBuilder>().To<ItemOrderViewModelSelectListBuilder>();
                ...
                kernel.Bind<ISemifinishedItemHandoverService>().To<SemifinishedItemHandoverService>();
                kernel.Bind<ISemifinishedItemHandoverViewModelSelectListBuilder>().To<SemifinishedItemHandoverViewModelSelectListBuilder>();
                kernel.Bind<ISemifinishedProductHandoverService>().To<SemifinishedProductHandoverService>();
                kernel.Bind<ISemifinishedProductHandoverViewModelSelectListBuilder>().To<SemifinishedProductHandoverViewModelSelectListBuilder>();



                kernel.Bind<ISemifinishedRecyclateService>().To<SemifinishedRecyclateService>();
                kernel.Bind<ISemifinishedRecyclateRepository>().To<SemifinishedRecyclateRepository>();
                kernel.Bind<ISemifinishedRecyclateAPIRepository>().To<SemifinishedRecyclateAPIRepository>();
                kernel.Bind<ISemifinishedRecyclateViewModelSelectListBuilder>().To<SemifinishedRecyclateViewModelSelectListBuilder>();




                kernel.Bind<IFinishedItemService>().To<FinishedItemService>();
                kernel.Bind<IFinishedItemRepository>().To<FinishedItemRepository>();
                kernel.Bind<IFinishedItemAPIRepository>().To<FinishedItemAPIRepository>();
                kernel.Bind<IFinishedItemViewModelSelectListBuilder>().To<FinishedItemViewModelSelectListBuilder>();
