...
namespace TotalPortal.Configuration
{
    public static class Settings
    {
        ...
        public static string kfmN3 { get { return "{0:n" + GlobalEnums.rndN3.ToString("N0") + "}"; } }
        ...
        public static int PopupHeightMedium = 427;
        ...
        public static int PopupContentHeightMedium = 269;
    ...
    public class MySettings
    {
        ...
        public string kfmN3 { get { return Settings.kfmN3; } }
