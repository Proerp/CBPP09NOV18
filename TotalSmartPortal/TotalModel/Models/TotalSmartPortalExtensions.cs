...
namespace TotalModel.Models
{
    ...
    {
        public string Features { get { return (this.BlendingInstructionID + 100000).ToString("{0}") + " " + (this.Code != null ? this.Code : "") + " SP: " + this.ProductCode + " [" + this.ProductName + "]" + (this.Jobs != null ? " {" + this.Jobs + "}" : ""); } }
    }
