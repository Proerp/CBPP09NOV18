...
namespace TotalCore.Helpers
{
    public static class SystemInfos
    {
        public static bool Validate()
        {
            ...
            //string systemInfoDecrypt = SecureEncoding.Decrypt("9AjMX2WmdH1+f1gY28KOSIrnL3TmPUpAWOsRtqiPRqvMGh2ghwBv2xaZX73H9J2HdhsEjFDPEREvvqZWNMhmNZnwzIpQM0n+8sSgl7GDLB7KbU7rEjaLkIMwkLnkPwlodV/iEYCrEvEl02uekv3t2A=="); //E7240T
